...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
                        ...
                        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-[1.1] tracking-tight">
                            ...
                            <span className="relative inline-block">
                                ...
                                <svg className="absolute -bottom-2 left-0 w-full h-3" viewBox="0 0 400 12" preserveAspectRatio="none">
                                    <path d="M 0 8 Q 100 4 200 8 T 400 8" fill="none" stroke="green" strokeWidth="2.5" strokeLinecap="round" opacity="0.9" />
                                </svg>
                            </span>
                        </h1>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="relative bg-white rounded-2xl p-10 border border-gray-200/60 shadow-xl shadow-gray-200/50">
                        ...
                        <div className="flex items-center gap-3 pl-4">
                            <div className="w-12 h-12 bg-gradient-to-br from-black-500 to-gray-700 rounded-full shadow-md" />
                            <div>
            ...
            {/* CTA Section */}
            <section className="relative py-24 px-6 lg:px-8 bg-gradient-to-br from-blue-460 to-blue-300 overflow-hidden">
