    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
                scrolled ? 'bg-white/80 backdrop-blur-xl border-b border-gray-200/50 shadow-sm shadow-gray-100/5' : ''
            }`}>
                    ...
                    <div className="flex items-center justify-between h-16">
                        <Link href="/" className="flex items-center gap-2.5 group cursor-pointer">
                            <div className="relative">
                              ...
                              {/*<div className="relative w-9 h-9 bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 rounded-xl flex items-center justify-center transform group-hover:scale-105 transition-transform shadow-lg shadow-gray-800/25">*/}
                                    <Image
                                        src="/kampus-logo.png"
                                        width={25}
                                        height={25}
            ...
            <section className="relative pt-32 pb-24 px-6 lg:px-8 overflow-hidden">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    {/* Floating book icon */}
                    <svg className="absolute top-32 right-[15%] w-16 h-16 text-gray-300/30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                        <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                    {/* Curved arrow */}
                    <svg className="absolute top-48 left-[12%] w-24 h-24 text-gray-300/25" viewBox="0 0 100 100">
                    ...
                    {/* Star doodle */}
                    <svg className="absolute top-[55%] right-[8%] w-14 h-14 text-gray-300/30" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 2l2.4 7.4h7.6l-6 4.6 2.3 7-6.3-4.6-6.3 4.6 2.3-7-6-4.6h7.6z"/>
                    </svg>
                    {/* Chat bubble */}
                    <svg className="absolute bottom-32 left-[18%] w-12 h-12 text-gray-300/25" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
                    </svg>
                    {/* Underline scribble */}
                    <svg className="absolute top-[38%] left-[35%] w-32 h-8 text-gray-400/20" viewBox="0 0 200 40">
                ...
                <div className="max-w-7xl mx-auto relative">
                    <div className="max-w-3xl mx-auto text-center">
                        {/* Status badge */}
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-gray-100 to-gray-50 border border-gray-200/40 rounded-full mb-8 shadow-sm">
                        ...
                        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-[1.1] tracking-tight">
                            ...
                            <span className="relative inline-block">
                                ...
                                <svg className="absolute -bottom-2 left-0 w-full h-3" viewBox="0 0 400 12" preserveAspectRatio="none">
                                    <path d="M 0 8 Q 100 4 200 8 T 400 8" fill="none" stroke="rgb(64, 64, 64)" strokeWidth="2.5" strokeLinecap="round" opacity="0.3" />
                                </svg>
                            </span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-12">
                            <Link href="/signup">
                                <button className="group relative px-7 py-3.5 bg-gradient-to-br from-gray-700 to-gray-900 hover:from-gray-800 hover:to-gray-950 text-white rounded-xl font-medium transition-all shadow-lg shadow-gray-800/25 hover:shadow-xl hover:shadow-gray-800/40 flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="text-center group">
                                ...
                                <div className="text-4xl font-bold bg-gradient-to-br from-gray-700 to-gray-900 bg-clip-text text-transparent mb-1">
                                    {stat.number}
                                </div>
            ...
            <section className="py-24 px-6 lg:px-8 bg-gradient-to-b from-gray-50/50 to-white">
                <div className="max-w-4xl mx-auto">
                    <div className="relative bg-white rounded-2xl p-10 border border-gray-200/60 shadow-xl shadow-gray-200/50">
                        {/* Quote mark */}
                        <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-gray-700 to-gray-900 rounded-xl flex items-center justify-center shadow-lg shadow-gray-800/25">
                        ...
                        <div className="flex items-center gap-3 pl-4">
                            <div className="w-12 h-12 bg-gradient-to-br from-gray-500 to-gray-700 rounded-full shadow-md" />
                            <div>
            ...
            {/* CTA Section */}
            <section className="relative py-24 px-6 lg:px-8 bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 overflow-hidden">
                ...
                <div className="max-w-3xl mx-auto text-center relative">
                    ...
                    <Link href="/signup">
                        <button className="px-8 py-4 bg-white text-gray-800 hover:bg-gray-100 rounded-xl font-semibold transition-all shadow-xl hover:shadow-2xl hover:scale-105">
                            Get started free
                        </button>
                    </Link>
